...
export default function ManualHeader() {
  const { enableWeb3, isWeb3Enabled, isWeb3EnableLoading, account, Moralis, deactivateWeb3 } =
    useMoralis();
  // useMoralis is a hook that gives us access to the Moralis object and some other stuff
  // it allows as to keep track of state of the application
  // hooks can help re-render the page when the state changes
